...
[`@aws-sdk/client-cognito-identity-provider`](https://www.npmjs.com/package/@aws-sdk/client-cognito-identity-provider/v/3.1086.0).
...
- @aws-sdk/client-cognito-identity-provider v3.1086.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cognito-identity-provider&version=3.1086.0](https://cloud-sdk-builds.github.io/?sdk=client-cognito-identity-provider&version=3.1086.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.1086.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FAaiGzSt/WSGaHNKSmxhArdH1Kv+tCy4awcGAObHQujGLkQSmWy2alRAv2p12cr8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-identity-provider": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.1086.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.1086.0/index.min.mjs": "sha384-FAaiGzSt/WSGaHNKSmxhArdH1Kv+tCy4awcGAObHQujGLkQSmWy2alRAv2p12cr8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-identity-provider/blob/refs/tags/3.1086.0/LICENSE
```
