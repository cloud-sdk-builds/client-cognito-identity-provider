...
[`@aws-sdk/client-cognito-identity-provider`](https://www.npmjs.com/package/@aws-sdk/client-cognito-identity-provider/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wabLEdbfhYrtqTy5q7cXPENA9BeMO3ebuWCCHYMUVL5Nptyg52bt9EJQ4rfABaB+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-identity-provider": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-identity-provider@3.100.0/index.min.mjs": "sha384-wabLEdbfhYrtqTy5q7cXPENA9BeMO3ebuWCCHYMUVL5Nptyg52bt9EJQ4rfABaB+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-identity-provider/blob/refs/tags/3.100.0/LICENSE
```
